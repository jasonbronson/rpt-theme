                              ...
                              <div class="col-md-6 col-md-offset-2">
                                  <div class='form-row'>
                                      <div class='form-group '>
                                          ...
                                          <div class="col-md-6">
                                              <select class="input-md col-sm-4" name="state" required>
                              ...
                              <div class="col-md-6 col-md-offset-2">
                                  <div class='form-row'>
                                      <div class='form-group '>
                                          ...
                                          <div class="col-md-6">
                                              <input class='form-control' type='text' name="zip" value="" required>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-md-6 col-md-offset-2">
                                  <div class='form-row'>
                                      <div class='form-group required'>
                                          ...
                                          <div class="col-md-6">
                                              <select class="input-md col-sm-12" name="country" required>
                                                  <?php 
